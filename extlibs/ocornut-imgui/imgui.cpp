...
// - 'size_on_first_use' for a regular window denote the initial size for first-time creation (no saved data) and isn't that useful. 
//Use SetNextWindowSize() prior to calling Begin() for more flexible window manipulation.
