...
restart:
	...
	bool processEvents(uint32_t& _width, uint32_t& _height, uint32_t& _debug, uint32_t& _reset, MouseState* _mouse, char* _inputChar)
	{
		s_debug = _debug;
		s_reset = _reset;
				...
				case Event::Char:
					{
						...
						if(_inputChar)
							*_inputChar = static_cast<char>(*inputGetChar());
					}
					break;
